...
void taskUpdate(void *pvParameters)
{
  vTaskDelay(60000);
  download_file = true;
  GW.downloadFile("https://raw.githubusercontent.com/LucasFeliciano21/Geteway_Comando/master/build/ESP32_gateway_Async.ino.bin", "/images/ESP32_gateway_Async.ino.bin", &received_size, &actual_received_size);
  // // vTaskDelay(1000);
  download_file = false;
